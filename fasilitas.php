...
<div class="container py-5">
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
        ...
        <div class="col">
            <div class="card h-100 shadow-sm border-0 news-card-new"> <img src="https://images.unsplash.com/photo-1576765608866-501103c5b7f5?auto=format&fit=crop&w=800&q=80" class="card-img-top news-card-img-new" alt="Kamar VIP">
                <div class="card-body">
        ...
        <div class="col">
            <div class="card h-100 shadow-sm border-0 news-card-new">
                <img src="https://images.unsplash.com/photo-1612178991-281de4605933?auto=format&fit=crop&w=800&q=80" class="card-img-top news-card-img-new" alt="Kamar Kelas 1">
                <div class="card-body">
    ...
    <div class="row g-4 py-3 row-cols-1 row-cols-lg-3">
        ...
        <div class="col d-flex align-items-start">
            <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 me-3 rounded-3 p-3">
                <i class="bi bi-heart-pulse"></i>
            </div>
            <div>
                <h4 class="fw-bold mb-0">Unit Gawat Darurat (UGD)</h4>
                <p class="text-muted">Siap 24 jam dengan tim medis profesional dan peralatan lengkap.</p>
            </div>
        </div>
        ...
        <div class="col d-flex align-items-start">
            ...
            <div>
                <h4 class="fw-bold mb-0">Laboratorium</h4>
                <p class="text-muted">Pemeriksaan patologi, mikrobiologi, dan tes darah yang akurat.</p>
            </div>
        </div>
        ...
        <div class="col d-flex align-items-start">
            ...
            <div>
                <h4 class="fw-bold mb-0">Radiologi & Pencitraan</h4>
                <p class="text-muted">Didukung teknologi X-Ray, CT-Scan, dan MRI terbaru.</p>
            </div>
        </div>
        ...
        <div class="col d-flex align-items-start">
            ...
            <div>
                <h4 class="fw-bold mb-0">Farmasi / Apotek</h4>
                <p class="text-muted">Menyediakan obat-obatan lengkap dan resep 24 jam.</p>
            </div>
        </div>
        ...
        <div class="col d-flex align-items-start">
            ...
            <div>
                <h4 class="fw-bold mb-0">Kantin & Kafetaria</h4>
                <p class="text-muted">Menyediakan makanan sehat dan higienis untuk pasien dan keluarga.</p>
            </div>
        </div>
        ...
        <div class="col d-flex align-items-start">
            ...
            <div>
                <h4 class="fw-bold mb-0">Area Parkir Luas</h4>
                <p class="text-muted">Area parkir yang aman dan memadai untuk kenyamanan pengunjung.</p>
            </div>
        </div>
